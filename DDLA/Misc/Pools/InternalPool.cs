...
namespace DDLA.Misc.Pools
{
    ...
    {
        public static InternalPool Instance { get; }
            = new InternalPool();
    ...
    public readonly struct VectorHandle(InternalPool pool,
         ArrayHandle handle) : IPooledHandle<Vector>
    {
        public ArrayHandle InternelHandle { get;} = handle;

        public InternalPool Pool { get; } = pool;
    ...
    public readonly struct MatrixHandle(InternalPool pool,

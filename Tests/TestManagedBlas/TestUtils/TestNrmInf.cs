...
public class TestNrmInf
{
    ...
    {
        var blas_nrmInf = BlasProvider.NrmInf(A, uplo);
        var blis_nrmInf = BlisProvider.NrmInf(A, uplo);
        Assert.AreEqual(blis_nrmInf, blas_nrmInf, 1e-10);
    }
}
